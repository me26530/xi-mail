const en = {
    ...
    senderFilterModeDesc: 'Blacklist: block listed sender domains, accept everything else. Whitelist: only accept mail from listed authorized domains, reject all others. The button edits the list for the current mode',
    senderFilterBlacklist: 'Blacklist',
    senderFilterWhitelist: 'Whitelist',
    senderDomainWhitelist: 'Sender Domain Whitelist',
    senderDomainWhitelistDesc: 'Only accept mail from these authorized domains; all other senders are rejected. Empty list means no restriction',
    senderDomainWhitelistHint: 'Add authorized sender domains (domain only, e.g. amazonses.com). Subdomains are also authorized; either envelope sender or header From matching allows delivery. Note: an empty whitelist means no restriction',
    senderDomainWhitelistPlaceholder: 'Enter domain and press Enter, e.g. amazonses.com',
    ...
    regKeyHintEn: 'Reg Code Hint (English)',
    regKeyHintEnDesc: 'Hint text shown in English mode. Falls back to default hint if empty.',
    regKeyHintEnPlaceholder: 'e.g. Contact admin to get a code',
    ...
    loginTemplate: 'Login Page Template',
    templateGradient: 'Ink Wash',
    templateMinimal: 'Minimal',
    templateSplit: 'Split',
    templateGlassmorphism: 'Glass',
    templateAurora: 'Aurora',
    templateGeometric: 'Geometric',
    layoutMode: 'Navigation Layout',
    layoutDefault: 'Full Sidebar',
    layoutCompact: 'Compact Sidebar',
    layoutTop: 'Top Bar',
    ...
    setupDesc: 'Enter your Xi-Mail Worker API URL to get started',
    serverName: 'Server Name',
    serverNamePlaceholder: 'e.g. My Mail',
    serverUrl: 'API URL',
    serverUrlPlaceholder: 'e.g. https://xi-mail.workers.dev/api',
    serverConnect: 'Connect',
    serverConnecting: 'Connecting...',
    serverConnectSuccess: 'Connected successfully',
    serverConnectFail: 'Unable to connect to server',
    serverInvalid: 'Please enter a valid server URL',
    ...
    serverEmpty: 'No servers configured',
    serverTestConnect: 'Test Connection',
    subWorkerManage: 'Sub Workers',
    subWorkerAdd: 'Add Sub Worker',
    subWorkerName: 'Name',
    subWorkerUrl: 'API URL',
    subWorkerToken: 'API Token',
    subWorkerDomains: 'Domains',
    subWorkerStatus: 'Status',
    subWorkerEnabled: 'Enabled',
    subWorkerDisabled: 'Disabled',
    subWorkerTestConnect: 'Test Connection',
    subWorkerTestSuccess: 'Connected, {count} domain(s) detected',
    subWorkerTestFail: 'Connection failed',
    subWorkerAddSuccess: 'Sub worker added successfully',
    subWorkerDeleteConfirm: 'Delete this sub worker?',
    subWorkerEmpty: 'No sub workers configured',
    subWorkerUrlPlaceholder: 'e.g. https://xi-mail-sub.workers.dev',
    subWorkerTokenPlaceholder: 'Sub worker api_token',
    subWorkerNamePlaceholder: 'e.g. Backup Mail',
}
