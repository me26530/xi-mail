const zh = {
    ...
    senderFilterModeDesc: '黑名单：屏蔽名单内的发件域名，其他都收；白名单：仅接收名单内授权域名的邮件，其他全部拒收。右侧按钮编辑当前模式的名单',
    senderFilterBlacklist: '黑名单',
    senderFilterWhitelist: '白名单',
    senderDomainWhitelist: '发件人域名白名单',
    senderDomainWhitelistDesc: '仅接收来自这些授权域名的邮件，其他发件人一律拒收；留空则不限制',
    senderDomainWhitelistHint: '添加授权的发件人域名（仅填写域名部分，如 amazonses.com），其子域名也视为授权；信封发件人或邮件头 From 任一匹配即放行。注意：白名单为空时不做限制',
    senderDomainWhitelistPlaceholder: '输入域名用回车添加，如 amazonses.com',
    regKeyHint: '注册码获取提示',
    regKeyHintDesc: '注册页注册码输入框下方显示的提示文字，例如"联系管理员获取"',
    regKeyHintPlaceholder: '例如：联系管理员获取注册码',
    regKeyHintEn: '注册码提示（英文）',
    regKeyHintEnDesc: '英文环境下显示的注册码获取提示，留空则显示中文提示',
    ...
    templateMinimal: '简约',
    templateSplit: '分栏',
    templateGlassmorphism: '玻璃',
    templateAurora: '极光',
    templateGeometric: '几何',
    layoutMode: '导航布局',
    layoutDefault: '完整侧边栏',
    layoutCompact: '精简侧边栏',
    layoutTop: '顶栏导航',
    ...
    accountTotal: '个邮箱',
    setupTitle: '连接服务器',
    setupDesc: '请输入 Xi-Mail Worker 的 API 地址以开始使用',
    serverName: '服务器名称',
    serverNamePlaceholder: '例如：我的邮箱',
    serverUrl: 'API 地址',
    serverUrlPlaceholder: '例如：https://xi-mail.workers.dev/api',
    serverConnect: '连接',
    serverConnecting: '连接中...',
    serverConnectSuccess: '连接成功',
    serverConnectFail: '无法连接到服务器',
    serverInvalid: '请输入有效的服务器地址',
    serverManage: '服务器管理',
    serverAdd: '添加服务器',
    serverRemove: '移除',
    serverSwitch: '切换',
    ...
    serverOffline: '未连接',
    serverEmpty: '暂无服务器',
    serverTestConnect: '测试连接',
    subWorkerManage: '子服务器',
    subWorkerAdd: '添加子服务器',
    subWorkerName: '名称',
    subWorkerUrl: 'API 地址',
    ...
    subWorkerStatus: '状态',
    subWorkerEnabled: '启用',
    subWorkerDisabled: '禁用',
    subWorkerTestConnect: '测试连接',
    subWorkerTestSuccess: '连接成功，检测到 {count} 个域名',
    subWorkerTestFail: '连接失败',
    subWorkerAddSuccess: '子服务器添加成功',
    subWorkerDeleteConfirm: '确定删除该子服务器？',
    subWorkerEmpty: '暂无子服务器',
    subWorkerUrlPlaceholder: '例如：https://xi-mail-sub.workers.dev',
    subWorkerTokenPlaceholder: '子 Worker 的 api_token',
    subWorkerNamePlaceholder: '例如：备用邮箱',
}
export default zh
